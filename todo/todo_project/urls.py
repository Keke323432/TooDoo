...
urlpatterns = [
    ...
    path('categories/mark/<int:category_id>/', mark_global, name='mark_global'),
    path('categories/unmark/<int:category_id>/', unmark_global, name='unmark_global'),
